...
var getRecentCommentsList = function getRecentCommentsList(params) {
    ...
    _getRecentIssues(params, function (issues) {
        ...
        _getRecentComments(params, function (comments) {
            ...
            if (navigator.userAgent.indexOf("MSIE") != -1 || navigator.userAgent.indexOf("Edge") != -1 || (navigator.userAgent.indexOf("Safari") != -1 && navigator.userAgent.indexOf("Chrome") == -1) || !!document.documentMode == true) {
